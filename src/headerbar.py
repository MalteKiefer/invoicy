...
class Headerbar(Gtk.HeaderBar):
    ...
    def __init__(self, parent):
        ...
        self.update_company = Gtk.Button(None,image=Gtk.Image.new_from_gicon(Gio.ThemedIcon(name="system-users"), Gtk.IconSize.LARGE_TOOLBAR))
        self.pack_start(self.update_company)
